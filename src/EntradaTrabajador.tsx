    ...
    return (
        <div>
            ...
            <div className="d-flex flex-row justify-content-center ms-4">
                ...
                <button disabled={!(trabajadorCode !== "" && trabajadores.find((trabajador) => trabajador.code === trabajadorCode))} className="btn btn-primary" onClick={() => navigate("/trabajador?code=" + trabajadorCode)}>Acceso</button>
            </div>
        </div>
    )
}
